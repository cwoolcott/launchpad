...
const ALPACA_API_KEY = process.env.ALPACA_API_KEY_LIVE;
const ALPACA_SECRET_KEY = process.env.ALPACA_API_KEY_LIVE;

const alpaca = new Alpaca({
  keyId: ALPACA_API_KEY_LIVE,
  secretKey: ALPACA_SECRET_KEY_LIVE,
